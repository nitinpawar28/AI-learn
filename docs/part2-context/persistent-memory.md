...
[Sankshep](../part0-orientation/running-example.md) — as of 2026-07-18, at v1.8.0 — exposes memory through three of its tools: `remember`, `recall`, and `export_decisions`. Tools are covered in [Part 3](../part3-mcp/primitives.md).
